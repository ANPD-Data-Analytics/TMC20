...
Out_AMZTMCPlug_wEQ$`Period Description` <- as.Date(Out_AMZTMCPlug_wEQ$`Period Description`, format = "%m/%d/%Y")
Out_AMZTMCPlug_wEQ$`Period Description` <-   format(prevweekday(prevweekday(Out_AMZTMCPlug_wEQ$`Period Description`, 14), 7), "%m-%d-%Y") 
